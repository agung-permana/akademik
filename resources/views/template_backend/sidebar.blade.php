...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="" class="brand-link" style="">
        <img src="{{ asset('img/favicon_logo.png') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3">
        <span class="brand-text font-weight-light"><strong>S I A K A D</strong></span>
    </a>
