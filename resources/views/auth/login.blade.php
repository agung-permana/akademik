...
<div class="card-body login-card-body" style="border-radius: 10px;">
  <h5 class="login-box-msg">Silahkan Login</h5>

  <form action="{{ route('login') }}" method="post">
    @csrf
    <div class="input-group mb-3">
      <input id="email" type="username" class="form-control @error('username') is-invalid @enderror" placeholder="Masukan Username" name="username" value="{{ old('username') }}" autocomplete="off" autofocus>
