...
<div class="card-body login-card-body" style="border-radius: 10px;">
  <h5 class="login-box-msg">Silahkan Registrasi</h5>
  ...
  <form action="{{ route('register') }}" method="post">
    ...
    <div class="input-group mb-3">
      <input id="email" type="username" placeholder="Username" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" autocomplete="off">
      <div class="input-group-append">
        <div class="input-group-text">
          <span class="fas fa-envelope"></span>
        </div>
    ...
    <div class="row mb-3">
      <div class="col-6">
        <a href="{{ route('login') }}" class="text-center btn btn-clear text-blue">Login Saja</a>
      </div>
      <!-- /.col -->
